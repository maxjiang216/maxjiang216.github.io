...
\\[x_i|x_i|=x_{i+1\pmod n}|x_{i+1\pmod n}|+(x_i-a)|x_i-a|,\forall i\in\{1,2,\ldots,n\}.\\]
...
\\[\sum_{i=1}^nx_i^2=\sum_{i=1}^nx_i^2\pm\sum_{i=1}^n(x_i_a)^2\implies\sum_{i=1}^n(x_i-a)^2=0\\]
